...
import fr.tyvaliarp.tyvaliamod.blocks.*;
...
public class ModBlocks {
    ...
    public static Block weed_plant, road, road_line, lootbox_ultimate, lootbox_gun, lootbox_car, atm, custom_furnace, mining_server;
    ...
    public void init() {
        ...
        atm = new BlockATM();
        custom_furnace = new BlockCustomFurnace();
        mining_server = new BlockMiningServer();
