...
public class GuiTyvaliaInGameMenu extends GuiIngameMenu
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + -16 - 12, 200, 20, I18n.format("menu.options")));
        ...
        this.buttonList.add(new GuiButton(6, this.width / 2 - 100, this.height / 4 + 48 + -16 + 12, 200, 20, I18n.format("gui.stats")));
    }
